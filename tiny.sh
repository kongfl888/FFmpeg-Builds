...
FF_CONFIGURE_SMALL=" --disable-encoder=avrp --disable-encoder=avui --disable-encoder=dvvideo --disable-encoder=exr --disable-encoder=flashsv --disable-encoder=flashsv2 --disable-encoder=flv --disable-encoder=h261 --disable-encoder=h263 --disable-encoder=h263p --disable-encoder=qoi --disable-encoder=qtrle --disable-encoder=smc --disable-encoder=rpza --disable-encoder=v408 --disable-encoder=rv10 --disable-encoder=rv20 --disable-encoder=wmv1 --disable-encoder=wmv2"
FF_CONFIGURE_SMALL+=" --disable-encoder=real_144 --disable-encoder=wmav1 --disable-encoder=wmav2 --disable-decoder=mov_text"
FF_CONFIGURE_SMALL+=" --disable-muxer=3g2 --disable-muxer=3gp --disable-muxer=amr --disable-muxer=avm2 --disable-muxer=dv --disable-muxer=flv --disable-muxer=h261 --disable-muxer=h263 --disable-muxer=rm --disable-muxer=swf"
FF_CONFIGURE_SMALL+=" --enable-small"
